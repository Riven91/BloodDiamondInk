          ...
          <div>
            ...
            <div className="mt-4 text-sm text-blooddiamond-text/80">
              <section className="space-y-5">
                <p>
                  <strong>Blood Diamond Tattoo Ink.</strong> steht für moderne Tattoo-Kunst in der Raum <strong>Pforzheim</strong> Mühlacker und im, <strong>Enzkreis</strong>. Unser Studio verbindet ästhetisches Design, präzises Handwerk und ruhige <strong>Private Rooms</strong>, in denen du und dein Motiv im Mittelpunkt stehen.
                </p>
                <p>
