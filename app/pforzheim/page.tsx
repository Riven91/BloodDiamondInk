        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 md:grid-cols-3">
            {[
              {
                src: "/Studio1.jpeg",
                alt: "Empfangsbereich von Blood Diamond Tattoo Ink. in Pforzheim",
              },
              {
                src: "/Studio2.jpeg",
                alt: "Tattoo-Arbeitsplatz bei Blood Diamond Tattoo Ink. in Pforzheim",
              },
              {
                src: "/Studio3.jpeg",
                alt: "Detailansicht des Studios von Blood Diamond Tattoo Ink. in Pforzheim",
              },
            ].map((image) => (
              <div
                key={image.src}
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-blooddiamond-primary/40 bg-blooddiamond-background/80 p-6">
              ...
              <p className="mt-3 text-sm text-blooddiamond-text/70">
                Blood Diamond Tattoo Ink. Pforzheim vernetzt lokale und globale Kunstschaffende und veranstaltet regelmäßige Walk-In Days für spontane Tattoo-Projekte.
              </p>
            </div>
          </div>
        </div>
