  ...
  return (
    <section className="mx-auto max-w-6xl px-4 pb-16">
      ...
      <div className="mt-6 grid gap-6 sm:grid-cols-3">
        <Link href="/pforzheim" className="rounded-2xl border p-5 hover:bg-gray-50">
          <h3 className="font-semibold">Pforzheim (Ötisheim)</h3>
        </Link>
        <Link href="/heilbronn" className="rounded-2xl border p-5 hover:bg-gray-50">
          <h3 className="font-semibold">Heilbronn (Neckarsulm)</h3>
        </Link>
        <Link href="/boeblingen" className="rounded-2xl border p-5 hover:bg-gray-50">
