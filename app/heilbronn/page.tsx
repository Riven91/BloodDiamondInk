    ...
    <>
        ...
        <div className="mx-auto grid max-w-5xl gap-10 px-6 md:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-sm text-blooddiamond-text/80">
              Blood Diamond Tattoo Ink. in Heilbronn verbindet moderne Atmosphäre mit ruhigen Private Rooms für konzentriertes Arbeiten an Ihrem individuellen Tattoo-Projekt.
            </p>
          </div>
      ...
      <section className="bg-blooddiamond-background py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mt-3 text-sm text-blooddiamond-text/80">
            Drei Artists von Blood Diamond Tattoo Ink. begleiten Sie von der Idee bis zur perfekten Umsetzung in Heilbronn.
          </p>
