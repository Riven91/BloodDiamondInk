    ...
    <>
      ...
      <section id="standorte" className="mx-auto max-w-6xl px-6 pb-16">
        ...
        <p className="mt-3 max-w-2xl text-blooddiamond-text/70">
          Unser Studio-Netzwerk wächst in Baden-Württemberg. Aktuell findest du unser Leitstudio in Pforzheim sowie spezialisierte Teams in Heilbronn und Böblingen – weitere Adressen folgen.
        </p>
