      ...
      <div className="mx-auto max-w-6xl px-6 pt-8 pb-6">
        <div className="flex flex-col gap-8 text-sm text-blooddiamond-text/60 md:flex-row md:items-start md:justify-between">
          ...
          <div className="flex flex-col gap-3 text-xs uppercase tracking-wide text-blooddiamond-text/70 md:text-right">
            ...
            <Link href="/impressum/boeblingen" className="hover:text-blooddiamond-accent">
              Impressum
            </Link>
            <Link href="/datenschutz/boeblingen" className="hover:text-blooddiamond-accent">
              Datenschutz
            </Link>
            <Link href="/agb/boeblingen" className="hover:text-blooddiamond-accent">
              AGB
            </Link>
          </div>
        </div>
