...
export default function FooterHeilbronn() {
  ...
  return (
    <footer id="footer" className="border-t border-neutral-800 bg-blooddiamond-muted/80">
      <div className="mx-auto max-w-6xl px-6 pt-8 pb-6 text-center text-sm text-neutral-400">
        <div className="flex flex-wrap items-center justify-center gap-5">
          ...
          >
            <svg className="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor">
              <path d="M21.58 7.19c-.23-.86-.9-1.52-1.76-1.75C18.25 5 12 5 12 5s-6.25 0-7.82.44c-.86.23-1.52.9-1.76 1.75C2 8.752 2 12 2 12s0 3.25.42 4.81c.23.86.9 1.52 1.76 1.75C5.75 19 12 19 12 19s6.25 0 7.82-.44c.86.23 1.52-.9 1.76-1.75C22 15.25 22 12 22 12s0-3.25-.42-4.81zM9.5 15.5V8.5l6.5 3.5-6.5 3.5z" />
            </svg>
            <span className="text-xs uppercase tracking-wider">YouTube</span>
          </a>
        </div>

        <div className="my-4 flex flex-col items-center justify-center gap-6 text-sm sm:flex-row">
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          <span className="font-display text-base uppercase text-white">Rechtliches</span>
          ...
          <button
            ...
            className="cursor-pointer border-none bg-transparent text-neutral-400 transition hover:text-white"
          >
